...
***************/
	...
	//A->Triangle(-1,-1, 0,0, -1,1,  1,1,0);	// Drawsa red triangle pointing right
	A->Triangle(-0.3,0.1, 0.1,-0.4, 0.1,0.6,   1,0,0); //R ed
    A->Triangle(-0.3,0.9, -0.3,0.1, 0.35,0.9,   0,0,1); //Blue
    A->Triangle(0.1,-0.4, 0.1,0.3, 0.4,-0.05,   1,1,0); //yellow

    A->Triangle(0.1,-0.4, 0.3,-0.634, 0.3,-0.166,   0.3,0.2,0.5);
    A->Triangle(0.5,-0.4, 0.3,-0.634, 0.3,-0.166,   0.3,0.2,0.5);

    A->Triangle(0.1,-0.4, 0.3,-0.634, 0.1,-0.868,   1,0.67,0.78);//pink
    A->Triangle(0.5,-0.4, 0.3,-0.634, 0.5,-0.868,   0.36,0.81,1); //cyan

    A->Triangle(-0.3,0.9, -0.5,0.6, -0.7,0.9,   0,1,0); //green
    A->Triangle(-0.9,0.6, -0.5,0.6, -0.7,0.9,   0,1,0); //green
